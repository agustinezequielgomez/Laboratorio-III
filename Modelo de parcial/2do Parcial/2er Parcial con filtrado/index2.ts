...
function crearArrayPersonas():Clases.Persona[]
{
    let arrayPersonas:Clases.Persona[] = [];
    data.forEach((personaData:any)=>
    {
        let persona:Clases.Persona = new Clases.Persona(personaData.id,personaData.first_name,personaData.last_name,personaData.email,personaData.age,personaData.gender);
